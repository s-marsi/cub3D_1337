...
AMINE_FILES_BONUS = $(addprefix ./bonus/, raycasting/start_bonus.c raycasting/door_bonus.c raycasting/init_player_bonus.c raycasting/get_position_bonus.c \
		...
		raycasting/cast_utils_bonus.c raycasting/move_utils_bonus.c raycasting/free_resources_bonus.c)
